...
class FashionPredictor:
    ...
    def __init__(
        ...
        # ========================================================
        # BASE GOOGLE ViT
        # Native ImageNet classifier for comparison
        # ========================================================

        print("Loading base Google ViT...")

        self.base_vit_processor = (
            AutoImageProcessor.from_pretrained(
                VIT_MODEL_NAME
            )
        )
        ...
        self.base_vit_model.eval()

        print("✅ Base Google ViT loaded")
    ...
    # ========================================================
    # BASE GOOGLE ViT PREDICTION
    # ========================================================

    def predict_base_vit(
        self,
        image: Image.Image
    ) -> list[dict[str, Any]]:

        inputs = self.base_vit_processor(
            images=image,
            return_tensors="pt"
        )
    ...
    def predict(
        ...
        base_vit_predictions = (
            self.predict_base_vit(image)
        )
        ...
        return {
            ...
            "base_model": {
                ...
                "description": (
                    "Original pretrained ViT "
                    "before fashion fine-tuning"
                ),
                "predictions": base_vit_predictions,
            },
        }
