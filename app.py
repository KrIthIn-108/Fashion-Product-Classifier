...
st.markdown(
    '<div class="hero-title">👕Fashion Product Classifier ⚙️📊</div>',
...
<div class="model-pills">
    <span>Features:</span>
    <div class="model-pill tooltip">
        CLIP Guardrail
        <span class="tooltip-text">
            Filters out non-fashion images before classification.
        </span>
    </div>
    <div class="model-pill tooltip">
        Class-Weighted ViT
        <span class="tooltip-text">
            Fine-tuned ViT that gives extra importance to rare classes.
        </span>
    </div>
    <div class="model-pill tooltip">
        Top-K Outputs
        <span class="tooltip-text">
            Shows the model's top 1 to 4 possible labels with confidence.
        </span>
    </div>
</div>
    """,
...
if (
    ...
    if base_model is not None:
        ...
        st.caption(
            "See what the original Google ViT "
            "predicts before it was fine-tuned "
            "for our fashion-specific tasks."
        )
        ...
        with st.expander(
            ...
            st.write(
                """
                These are predictions from the original
                pretrained Google ViT model
                (google/vit-base-patch16-224).

                Unlike our fine-tuned model, this model
                was not trained on our fashion dataset
                and does not predict our five custom
                fashion attributes.

                The comparison is intended to demonstrate
                how fine-tuning adapts a general-purpose
                vision model to a specific task.
                """
            )
# ============================================================
# FOOTER
